 ...
 * @author rmunene
 */
@WebServlet(name = "BI", urlPatterns = {"/BI"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String requestType = requestMap.get("service");
              if (requestType.equals("BI")) {
                String phonumber = requestMap.get("phoneNumber");
                Map<String, String> rs = db.balanceInquiry(phonumber);
                org.json.JSONObject balResp = new org.json.JSONObject();
                org.json.JSONObject balanceResp = new org.json.JSONObject(message);
                balanceResp.put("AvailableBal", rs.get("AvailableBal"));
                balanceResp.put("ActualBal", rs.get("ActualBal"));

                balResp.put("data", balanceResp);
                balResp.put("status", rs.get("status"));
                out.println(balResp.toString());
            }  else {
